...
class Constants {
  ...
  static const Color kPurpleColor = Color(0xFFA25FFF);
  ...
  static const Color kBlueColor = Color(0xFF776ED0);

  static const Gradient kGradientClr = LinearGradient(colors:[Colors.red,Colors.blue],);
